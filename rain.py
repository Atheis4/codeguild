...
data_list_tuple = get_rid_of_null_data_turn_numbers_to_int(new_line_list)
...
#
# daily_rainfall_per_year = []
#
# [daily_rainfall_per_year.append(v) for k, v in rainfall_dict.items() if k.endswith('02')]
#
#
#
#
# mean_rainfall_by_year = total_rainfall_by_year / len(daily_rainfall_per_year)
